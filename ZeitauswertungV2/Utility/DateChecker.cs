...
namespace ZeitauswertungV2.UI.Utility
{
    class DateChecker
    {
        ...
        public int getHoursofDay(DateTime date)
        {
            if (DateSystem.IsWeekend(date, CountryCode.DE))
            {
                return 0;
        ...
        public IEnumerable<Holiday> Holidays()
        {
            ...
            yield return new Holiday { Name = "Weihnachten", Date = new DateTime(2020,10,31), Hours = 4 };
            ...
            yield return new Holiday { Name = "Sylvester", Date = new DateTime(2020,12,26), Hours = 4 };
        }
    }
}
